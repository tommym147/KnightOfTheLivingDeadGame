...
public class GameOverScreen implements Screen {
    ...
    public GameOverScreen(Game game) {
        ...
        stage = new Stage(viewport, ((KnightOfTheLivingDead) game).batch);
        ...
        table.row();
        table.add(playAgainLabel).expandX().pad(10f);
    ...
    public void render(float delta) {
        if(Gdx.input.justTouched()) {
            game.setScreen(new PlayScreen((KnightOfTheLivingDead) game));
            dispose();
        }
